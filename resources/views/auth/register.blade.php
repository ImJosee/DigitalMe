...
<div class="div-reg-container container-fluid">
    <main class="register-main">
        ...
        <form class="register-form" action="{{ route('register') }}" method="POST">
            ...
            <div class="form-row">
                <div class="col">
                    <label class="labels" for="email">{{ __('E-Mail Address') }}</label>
            ...
            <div class="form-row">
                <div class="col">
                    <label class="labels" for="name">{{ __('Name') }}</label>
                ...
                <div class="col">
                    <label class="labels" for="last_name">{{ __('Last Name') }}</label>
            ...
            <div class="form-row">
                <div class="col">
                    <label class="labels" for="password-confirm">{{ __('Confirm Password') }}</label>
            ...
            <div class="form-row">
                <div class="col">
                    <input type="checkbox" name="remember"><span>  {{ __('Remember') }}</span>
                </div>
            </div>
            <div class="form-row">
                <div class="col">
                    <p>Haciendo clic en Crear cuenta, estoy de acuerdo en haber leído y aceptado <a href="#terminos&condiciones">la Condiciones de uso y la Política de privacidad</a>.</p>
                </div>
            </div>
            <div class="form-row">
                <div class="col">
                    <button type="submit" class="registrar btn btn-success">{{ __('Register') }}</button>
                </div>
            </div>
        </form>
    </main>
