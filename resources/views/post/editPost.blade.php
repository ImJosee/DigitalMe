    ...
    <form class="register-form" action="{{ url('/posts' )}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-row">
            <div class="col">
                ...
                <input id="title-edit" type="title" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $post->title}}" required autocomplete="title">
                @error('title')
            ...
            <div class="col">
                ...
                <input id="subtitle" type="text" class="form-control @error('subtitle') is-invalid @enderror" name="subtitle" value="{{ $post->subtitle}}" required autocomplete="subtitle" autofocus>
                    @error('subtitle')
        ...
        <div class="form-row">
            <div class="col">
                ...
                <textarea id="summernote" required class="form-control" value="{{$post->content}}" name="content"></textarea>
                @error('content')
